"""
Django settings for test_install_dev_106293 project.
...
ROOT_URLCONF = 'test_install_dev_106293.urls'
...
WSGI_APPLICATION = 'test_install_dev_106293.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_install_dev_106293 API",
    "DESCRIPTION": "API documentation for test_install_dev_106293 App",
    "VERSION": "v1",
}
